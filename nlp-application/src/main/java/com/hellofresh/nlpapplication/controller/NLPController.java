package com.hellofresh.nlpapplication.controller;

import com.hellofresh.nlpapplication.model.Type;
...
public class NLPController {
    ...
    @PostMapping
    @RequestMapping(value = "/nre")
    public Set<String> nre(@RequestBody final String input, @RequestParam final Type type) {
